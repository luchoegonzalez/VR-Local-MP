...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.SpatialKeyboard
{
    ...
    public class XRKeyboardDisplay : MonoBehaviour
    {
        ...
        /// If true, this display will clear the input field text on text submit from the keyboard.
        /// </summary>
        public bool hideKeyboardOnInputFieldClose
        {
            get => m_HideKeyboardOnInputFieldClose;
            set => m_HideKeyboardOnInputFieldClose = value;
        }
        
        [SerializeField, Tooltip("If true, The keyboard will close anytime the corresponding inputfield GameObject becomes inactive.")]
        public bool m_HideKeyboardOnInputFieldClose = true;
        ...
        void OnDisable()
        {
            ...
            if (m_ActiveKeyboard != null && m_ActiveKeyboard.gameObject.activeInHierarchy && hideKeyboardOnInputFieldClose && m_ActiveKeyboard.isOpen)
            {
