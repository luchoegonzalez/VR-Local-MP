...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.SpatialKeyboard
{
    ...
    public class XRKeyboardDisplayEditor : BaseInteractionEditor
    {
        ...
        protected SerializedProperty m_HideKeyboardOnInputFieldClose;
        ...
        protected static class Contents
        {
            ...
            public static readonly GUIContent hideKeyboardOnInputClose = EditorGUIUtility.TrTextContent("Hide Keyboard On Input Close", "If true, this display will hide the keyboard when this class OnDisable is called.");
        ...
        protected virtual void OnEnable()
        {
            ...
            m_HideKeyboardOnInputFieldClose = serializedObject.FindProperty("m_HideKeyboardOnInputFieldClose");
        ...
        protected override void DrawInspector()
        {
            ...
            EditorGUILayout.PropertyField(m_HideKeyboardOnInputFieldClose, Contents.hideKeyboardOnInputClose);
