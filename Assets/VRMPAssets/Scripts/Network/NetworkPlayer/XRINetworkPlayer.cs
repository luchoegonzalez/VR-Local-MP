...
namespace XRMultiplayer
{
    ...
    public class XRINetworkPlayer : NetworkBehaviour
    {
        ...
        /// </summary>
        [DataMember]
        public string playerName { get => m_PlayerName.Value.ToString(); set => m_PlayerName.Value = new FixedString128Bytes(value); }
        ...
        /// </summary>
        public Color playerColor { get => m_PlayerColor.Value; set => m_PlayerColor.Value = value; }
        ...
        [DataMember]
        public string playerColorName { get => playerColor.ToString(); }
        ...
        {
            get => this.OwnerClientId != 0 ? this.OwnerClientId : this.ownerId;
        ...
        /// <summary>
        /// If the player is going to use voice chat.
        /// </summary>
        public bool usingVoiceChat = false;
